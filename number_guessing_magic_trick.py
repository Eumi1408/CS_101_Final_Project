...
def final_answer(answer):
    if answer == "yes":
        ...
        Then, type 'python number_guessing_magic_game.py' and press Enter.
        .-._                                                   _,-,
  `._`-._                                           _,-'_,'
     `._ `-._                                   _,-' _,'
        `._  `-._        __.-----.__        _,-'  _,'
...
input_3 = input("""Choose a number between 1 and 10, let's call it 'c' and add it to the number you picked. 
Type 'c' here and press enter. """)
final_number += int(input_3)
input_4 = input("""Choose a number between 1 and 10, let's call it 'd' and subtract it from the number you picked. 
