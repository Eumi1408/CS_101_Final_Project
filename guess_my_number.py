...
input_1 = input("""Choose a number between 1 and 10, let's call it 'a'. Add it to the number 'x' you picked. 
Type 'a' here and press enter. """)
final_number += int(input_1)
input_2 = input("""Choose a number between 1 and 10, let's call it 'b'. Subtract it from the new number you just calculated. 
Type 'b' here and press enter. """)
final_number -= int(input_2)
input_3 = input("""Choose a number between 1 and 10, let's call it 'c'. Add it to the new number you just calculated. 
Type 'c' here and press enter. """)
final_number += int(input_3)
input_4 = input("""Choose a number between 1 and 10, let's call it 'd'. Subtract it from the new number you just calculated. 
